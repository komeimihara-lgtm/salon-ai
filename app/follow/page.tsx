  ...
  return (
    <div className="min-h-screen bg-[#F8F5FF] flex flex-col">
      <header className="flex items-center h-14 px-4 border-b border-[#E8E0F0] bg-white">
        ...
        <h1 className="flex-1 text-center text-sm font-bold text-[#2C2C2C]">自動フォロー</h1>
        <div className="w-9" />
      </header>
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-8">
        <div className="flex flex-col items-center justify-center py-16">
          ...
          <h2 className="text-lg font-bold text-[#2C2C2C] mb-2">自動フォロー</h2>
          <p className="text-[#6B7280] text-sm text-center">失客リマインド・お誕生日メッセージなどの自動送信機能</p>
