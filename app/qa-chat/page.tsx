  ...
  return (
    <div className="min-h-screen bg-[#0F1923] flex flex-col">
      <header className="flex items-center h-14 px-4 border-b border-[#2E3F5C]">
        ...
        <h1 className="flex-1 text-center text-sm font-bold text-white">Q&Aチャット</h1>
        <div className="w-9" />
      </header>
      <main className="flex-1 max-w-4xl mx-auto w-full px-4 py-8">
        <div className="flex flex-col items-center justify-center py-16">
          ...
          <h2 className="text-lg font-bold text-white mb-2">Q&Aチャット</h2>
          <p className="text-slate-400 text-sm text-center">よくある質問へのAI回答</p>
