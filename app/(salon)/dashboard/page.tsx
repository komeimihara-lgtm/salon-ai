    ...
    <div className="max-w-[1440px] mx-auto space-y-6">
      ...
      <section>
        <div className="flex items-center gap-3 mb-4">
          ...
          <span className="font-dm-sans text-2xl font-bold text-text-main">月間KPI</span>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <section className="lg:col-span-1">
          <div className="flex items-center gap-3 mb-4">
            <div className="gradient-line rounded-full" />
            <span className="font-dm-sans text-2xl font-bold text-text-main">今日の日割り目標</span>
          </div>
        ...
        <section className="lg:col-span-2">
          <div className="flex items-center gap-3 mb-4">
            <div className="gradient-line rounded-full" />
            <span className="font-dm-sans text-2xl font-bold text-text-main">今日のタスク</span>
          </div>
      ...
      <section>
        <div className="flex items-center gap-3 mb-4">
          <div className="gradient-line rounded-full" />
          <span className="font-dm-sans text-2xl font-bold text-text-main">今日の予約表</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[7fr_3fr] gap-6">
        <section className="min-w-0">
          <div className="flex items-center gap-3 mb-4">
            <div className="gradient-line rounded-full" />
            <span className="font-dm-sans text-2xl font-bold text-text-main">今日の来店客一覧</span>
          </div>
        ...
        <section>
          <div className="flex items-center gap-3 mb-4">
            <div className="gradient-line rounded-full" />
            <span className="font-dm-sans text-2xl font-bold text-text-main">今日の出勤スタッフ</span>
          </div>
