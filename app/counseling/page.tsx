...
function SolaAvatarImg({ size = 24, isSpeaking = false }: { size?: number; isSpeaking?: boolean }) {
  return (
    <div className="relative shrink-0">
      {isSpeaking && (
        <span
          className="absolute inset-0 rounded-full ring-2 ring-[#9B8EC4] animate-pulse"
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col max-w-lg mx-auto">
      ...
      <div className="flex flex-col items-center py-4 shrink-0">
        ...
        <p className="flex items-center gap-1.5 mt-1 text-xs text-emerald-600">
          <span className="w-2 h-2 rounded-full bg-emerald-500" /> オンライン
        </p>
      </div>
